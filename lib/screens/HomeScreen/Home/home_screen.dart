          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                ...
                colors: [const Color(0xFF111317).withValues(alpha:0.08), Colors.transparent],
                // colors: [const Color(0xFF00D2FF).withValues(alpha:0.08), Colors.transparent],
              ),
            ),
          ),
        ),
        Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              gradient: RadialGradient(
                colors: [const Color(0xFFEDB1FF).withValues(alpha:0.06), Colors.transparent],
                // colors: [const Color(0xFFEDB1FF).withValues(alpha:0.06), Colors.transparent],
              ),
            ),
          ),
